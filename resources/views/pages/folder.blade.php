  ...
  <div class="px-5 py-8 relative min-h-full">
    ...
    <form action="{{ route('note')  }}" method="POST" class="relative h-full overflow-auto">
        ...
        <div>
            ...
            <input type="hidden" name="note_editor_modal_note_id_name" id="note_editor_modal_note_id_name">
            <input type="hidden" name="note_editor_modal_note_folder_id_name" id="note_editor_modal_note_folder_id_name">


            <div class="absolute flex items-center gap-4 bottom-4">
                <button class=" bg-gray-600 rounded-full px-6 py-2 cursor-pointer" type="submit" name="action" value="update">Save</button>
